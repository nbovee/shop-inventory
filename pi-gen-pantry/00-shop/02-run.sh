...
export SHOP_DJANGO_SUPERUSER_USERNAME=${SHOP_DJANGO_SUPERUSER_USERNAME}
export SHOP_DJANGO_SUPERUSER_PASSWORD=${SHOP_DJANGO_SUPERUSER_PASSWORD}
export SHOP_DJANGO_SUPERUSER_EMAIL=${SHOP_DJANGO_SUPERUSER_EMAIL}
